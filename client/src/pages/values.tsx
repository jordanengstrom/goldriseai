          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="value-card group relative overflow-hidden p-8 rounded-[2.5rem] bg-white/20 dark:bg-slate-950/45 backdrop-blur-2xl border border-white/55 dark:border-slate-200/15 hover:border-primary/30 shadow-[0_24px_64px_-20px_rgba(0,0,0,0.24),inset_0_3px_4px_rgba(255,255,255,0.6),inset_0_-3px_4px_rgba(0,0,0,0.3)] dark:shadow-[0_24px_64px_-20px_rgba(2,6,23,0.75),inset_0_3px_4px_rgba(148,163,184,0.18),inset_0_-3px_4px_rgba(2,6,23,0.8)] transition-all duration-500 flex flex-col items-center text-center"
              >
