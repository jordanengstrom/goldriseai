    ...
    <Layout>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 flex flex-col items-center justify-center min-h-[80vh] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center z-10 w-full">
          <div className="relative overflow-hidden p-8 md:p-16 rounded-[2.5rem] bg-white/20 dark:bg-slate-950/45 backdrop-blur-2xl border border-white/55 dark:border-slate-200/15 shadow-[0_24px_64px_-20px_rgba(0,0,0,0.24),inset_0_3px_4px_rgba(255,255,255,0.6),inset_0_-3px_4px_rgba(0,0,0,0.3)] dark:shadow-[0_24px_64px_-20px_rgba(2,6,23,0.75),inset_0_3px_4px_rgba(148,163,184,0.18),inset_0_-3px_4px_rgba(2,6,23,0.8)] transition-all duration-500">
            <div className="pointer-events-none absolute inset-[20px] rounded-[2rem] bg-white/90 dark:bg-slate-950/82 shadow-[inset_0_4px_8px_rgba(0,0,0,0.2),inset_0_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[inset_0_4px_8px_rgba(2,6,23,0.7),inset_0_-4px_8px_rgba(148,163,184,0.15)]" />
