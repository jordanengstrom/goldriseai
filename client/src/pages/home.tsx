    ...
    <Layout>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 flex flex-col items-center justify-center min-h-dvh overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center z-10 w-full">
          <div id="glass-border" className="relative overflow-hidden p-8 md:p-16 rounded-[2.5rem] bg-white/20 dark:bg-[rgba(18,34,68,0.78)] backdrop-blur-2xl border border-white/55 dark:border-[rgb(106,156,235)] dark:ring-1 dark:ring-[rgba(120,184,255,0.42)] shadow-[0_24px_64px_-20px_rgba(0,0,0,0.24),inset_0_3px_4px_rgba(255,255,255,0.6),inset_0_-3px_4px_rgba(0,0,0,0.3)] dark:shadow-[0_34px_82px_-26px_rgba(2,6,23,0.92),0_0_36px_-12px_rgba(88,140,255,0.42),inset_0_3px_4px_rgba(190,220,255,0.22),inset_0_-3px_4px_rgba(8,12,26,0.86)] transition-all duration-500">
