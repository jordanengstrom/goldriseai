...
export default function Home() {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 flex flex-col items-center justify-center min-h-dvh overflow-hidden">
        <LiquidGradient />
        <div className="max-w-4xl mx-auto text-center z-10 w-full">
          <div className="relative overflow-hidden p-8 md:p-16 rounded-[2.5rem] bg-white/20 dark:bg-slate-950/72 backdrop-blur-2xl border border-white/55 dark:border-slate-200/20 shadow-[0_24px_64px_-20px_rgba(0,0,0,0.24),inset_0_3px_4px_rgba(255,255,255,0.6),inset_0_-3px_4px_rgba(0,0,0,0.3)] dark:shadow-[0_30px_70px_-24px_rgba(2,6,23,0.85),inset_0_3px_4px_rgba(148,163,184,0.12),inset_0_-3px_4px_rgba(2,6,23,0.92)] transition-all duration-500">
            <div id="elevate-your-business" className="pointer-events-none absolute inset-[20px] rounded-[2rem] bg-white/90 dark:bg-[#0f1f3d] dark:opacity-95 shadow-[inset_0_4px_8px_rgba(0,0,0,0.2),inset_0_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[inset_0_8px_16px_rgba(2,6,23,0.96),inset_0_-4px_8px_rgba(148,163,184,0.04)]" />
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(120%_90%_at_50%_18%,rgba(255,255,255,0.42)_0%,rgba(255,255,255,0.24)_34%,rgba(255,255,255,0.06)_64%,rgba(255,255,255,0)_100%)] dark:bg-[radial-gradient(120%_90%_at_50%_18%,rgba(148,163,184,0.08)_0%,rgba(148,163,184,0.04)_34%,rgba(148,163,184,0.01)_64%,rgba(148,163,184,0)_100%)]" />
            <div className="pointer-events-none absolute inset-[12%] rounded-[2rem] bg-[radial-gradient(circle_at_50%_38%,rgba(255,255,255,0.34),rgba(255,255,255,0.04)_68%,rgba(255,255,255,0)_100%)] dark:bg-[radial-gradient(circle_at_50%_38%,rgba(148,163,184,0.08),rgba(148,163,184,0.015)_68%,rgba(148,163,184,0)_100%)] blur-xl" />
