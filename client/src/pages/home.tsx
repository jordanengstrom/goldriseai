    ...
    <Layout>
      <div style={{position: 'relative'}}>
        <div className="absolute top-0 left-0 w-full" style={{height: 'calc(100vh + 1400px)', zIndex: 0, pointerEvents: 'none'}}>
          ...
          {/* SHORT CONTENT TEST: Uncomment to test short content */}
          {/* <div className="h-12 bg-red-100 text-center flex items-center justify-center">Short content test</div> */}
          {/* LONG CONTENT TEST: Uncomment to test long content */}
          {/* <div className="h-[2000px] bg-blue-100 text-center flex items-center justify-center">Long content test</div> */}
          {/* LIGHT/DARK MODE TEST: Uncomment to test mode toggle */}
