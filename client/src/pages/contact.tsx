          ...
          {contactInfo.email && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
              ...
              <motion.a
                ...
                className="group relative overflow-hidden p-8 rounded-[2.5rem] bg-white/20 dark:bg-slate-950/45 backdrop-blur-2xl border border-white/55 dark:border-slate-200/15 shadow-[0_24px_64px_-20px_rgba(0,0,0,0.24),inset_0_3px_4px_rgba(255,255,255,0.6),inset_0_-3px_4px_rgba(0,0,0,0.3)] dark:shadow-[0_24px_64px_-20px_rgba(2,6,23,0.75),inset_0_3px_4px_rgba(148,163,184,0.18),inset_0_-3px_4px_rgba(2,6,23,0.8)] hover:scale-105 transition-all duration-300 cursor-pointer"
              >
                <div className="pointer-events-none absolute inset-[10px] rounded-[2rem] bg-white/90 dark:bg-slate-950/82 shadow-[inset_0_4px_8px_rgba(0,0,0,0.2),inset_0_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[inset_0_4px_8px_rgba(2,6,23,0.7),inset_0_-4px_8px_rgba(148,163,184,0.15)] transition-colors duration-300 group-hover:bg-white/95 dark:group-hover:bg-slate-900/80" />
              ...
              <motion.div
                ...
                className="group relative overflow-hidden p-8 rounded-[2.5rem] bg-white/20 dark:bg-slate-950/45 backdrop-blur-2xl border border-white/55 dark:border-slate-200/15 shadow-[0_24px_64px_-20px_rgba(0,0,0,0.24),inset_0_3px_4px_rgba(255,255,255,0.6),inset_0_-3px_4px_rgba(0,0,0,0.3)] dark:shadow-[0_24px_64px_-20px_rgba(2,6,23,0.75),inset_0_3px_4px_rgba(148,163,184,0.18),inset_0_-3px_4px_rgba(2,6,23,0.8)]"
              >
