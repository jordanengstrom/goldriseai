    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-6 py-24 md:py-32 w-full">
        ...
        <div className="glass-panel p-8 md:p-12 rounded-2xl space-y-6 text-muted-foreground leading-relaxed prose prose-invert max-w-none">
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">3. Fees and Payment Terms</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">4. Intellectual Property Rights</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">5. Confidentiality</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">6. Changes to Terms</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">7. Account Registration and Use</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">8. Privacy Policy</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">9. Acceptable Use Policy</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">10. Third-Party Services</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">11. Termination</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">12. Disclaimer of Warranties</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">13. Limitation of Liability</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">14. Indemnification</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">15. Dispute Resolution and Arbitration</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">16. Governing Law</h3>
          <p>
          ...
          <h3 className="text-2xl font-display font-bold text-white pt-6">17. Severability</h3>
          <p>
            If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law, and the remaining provisions will continue in full force and effect.
          </p>
          
          <h3 className="text-2xl font-display font-bold text-white pt-6">18. Contact Us</h3>
          <p>
