...
export function HomeServicesSection() {
  return (
    <section
      id="services"
      className="relative pb-8 mb-10 px-6 overflow-hidden min-h-dvh flex flex-col items-center justify-center z-10"
    >
